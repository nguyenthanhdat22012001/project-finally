...
function ProductSearchPage() {
    ...
    /*************load page**************/
    useEffect(async () => {
        await getAllProductsBySearch(search);
    }, [search])

    /*************get all product**************/
    const getAllProductsBySearch = async (search) => {
        const param = {
            search: search,
        };
        try {
            const res = await productApi.getProductBySearch(param);
            if (res.success) {
        ...
        <div>
            ...
            <div className="product__wrapper">
                ...
                <article className="product__main">
                    <h2 className="product__main__title">{search}</h2>
